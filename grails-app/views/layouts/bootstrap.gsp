				...
				<div class="container-fluid">
					...
					<div class="nav-collapse">
						<ul class="nav">							
							...
							<sec:ifAllGranted roles="ROLE_ADMIN"><li <%= request.forwardURI.contains("${createLink(controller: 'admin')}") ? ' class="active"' : '' %>><a href="${createLink(controller: 'admin')}">Panel</a></li></sec:ifAllGranted>
						</ul>
					</div>
